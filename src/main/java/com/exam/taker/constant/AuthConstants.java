...
public interface AuthConstants {
    ...
    public static final String TOKEN_BLACK_MAP="AUTH:BLACK_MAP";
     ...
     * 有来后台管理客户端ID
     */
    String ADMIN_CLIENT_ID = "xingyuan-system";


    /**
     * 有来微信小程序客户端ID
     */
    String WEAPP_CLIENT_ID = "xiangyuan-mall-weapp";

    /**
     * 后台管理接口路径匹配
     */
    String ADMIN_URL_PATTERN = "*_/xingyuan-system/**";


    String LOGOUT_PATH = "/xingyuan-auth/oauth/logout";
